...
; function toString(arg)
  ...
  ; if (arg[0] === fnLabel) return strToChars("(fn ... )")

  ; if (arg[0] === symLabel) return strToChars("(sym ... )")
...
; function bracketed(env)
  {return (
     ...
     , function(arg)
       {return (
          [ listLabel
          , arg.map(function(elem) {return apply(Eval, env, elem)})])}))}
...
; var initEnv
  ...
  //                                  valObj(strLabel, varParts[0])))}
            ...
            ; if (stringIs(Var, "->str")) return constFn(makeFn(toString))
