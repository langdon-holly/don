...
; module.exports
  = { fromNumber: function(num) {return bigInt(num)}
    ...
    , div
      : function(numerator, denominator) {return numerator.divide(denominator)}
    , mod: function(numerator, denominator) {return numerator.mod(denominator)}
    , divMod
      : function(numerator, denominator) {return numerator.divmod(denominator)}
